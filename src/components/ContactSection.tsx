                    ...
                    <div className="relative flex items-end gap-x-2 p-2">
                        <div className="relative">
                            <button
                                ...
                                onClick={() => {
                                    window.open("https://www.github.com/M-Byte480", "_blank");
                                }}
                            >
                                <svg
                                    viewBox="0 0 24 24"
                        ...
                        <div className="relative">
                            <button
                                ...
                                onClick={() => {
                                    window.open("https://www.linkedin.com/in/milan-kovacs-cs/", "_blank");
                                }}
                            >
                                <svg
                                    viewBox="0 0 24 24"
                        ...
                        <div className="relative">
                            <button
                                ...
                                onClick={() => {
                                    window.open("https://www.youtube.com/@codewithmilan157", "_blank");
                                }}
                            >
                                <svg
                                    viewBox="0 0 24 24"
                        ...
                        <div className="relative">
                            <button
                                style={{clipPath: "url(#squircleClip)"}}
                                className="w-14 h-14 bg-gradient-to-br from-green-600 to-emerald-800 rounded-xl flex items-center justify-center shadow-lg border border-indigo-500/50 cursor-pointer transform transition-all duration-300 ease-out hover:scale-110 hover:-translate-y-2 hover:shadow-2xl"
                                onClick={() => window.location.href = "mailto:kmilanm13@gmail.com"}
                            >
                                <svg
                                    viewBox="0 0 24 24"
                                    fill="currentColor"
